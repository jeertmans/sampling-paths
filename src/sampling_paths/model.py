        ...
        *,
        ...
        def compute_flows_mask(
            ...
            if self.action_masking:
                ...
                # [3] Normal vector of the plane of the previous object
                normal = jnp.cross(
                    v1 - v0,
                    v2 - v0,
                )
                tx_dist = jnp.dot(
                    normal, -v0
                )  # Distance from TX at (0,0,0) to the plane of the previous object

                next_dists = jnp.sum(
                    (xyz - v0) * normal, axis=-1
                )  # Distances from the objects to the plane of the previous object
