...
def decrease_epsilon(
    ...
    """
    Return a custom Optax transformation that decreases the epsilon parameter of the model by delta_epsilon at each optimization step, down to a minimum of min_epsilon.
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            optim: The optimizer to use. If None, Muon with learning rate 1e-4 is used.
            delta_epsilon: The amount by which to decrease epsilon at each step.
            min_epsilon: The minimum value that epsilon can take.
        ...
        optim: optax.GradientTransformation = (
            optax.contrib.muon(1e-4) if optim is None else optim
        )
    ...
    def evaluate(
        ...
        *,
        ...
        accuracies, hit_rates = jax.lax.map(
            lambda xs: evaluate_on_one_scene(*xs),
            (scene_keys, keys),
        )
